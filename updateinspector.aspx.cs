...
{
    public partial class updateinspector : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            // Validate inputs
            if (string.IsNullOrEmpty(InspectorNo) || string.IsNullOrEmpty(name) ||
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                string updateQuery = "UPDATE inspector SET name = @Name, email = @Email, " +
                    "mobile = @Mobile WHERE inspector_no = @InspectorNo";
